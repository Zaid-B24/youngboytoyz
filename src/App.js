        ...
        <WishlistProvider>
          ...
          <div className="App">
            <Routes>
              ...
              <Route path="/collections/ybt" element={
                <>
                  <Header />
                  <YBTCollectionPage />
                  <Footer />
              ...
              <Route path="/collections/ybt-cars" element={
                <>
                  <Header />
                  <YBTCarsPage />
                  <Footer />
              ...
              <Route path="/collections/ybt-bikes" element={
                <>
                  <Header />
                  <YBTBikesPage />
                  <Footer />
              ...
              <Route path="/collections/designer" element={
                <>
                  <Header />
              ...
              <Route path="/collections/gs-designs" element={
                <>
                  <Header />
                  <GSDesignsPage />
                  <Footer />
              ...
              <Route path="/collections/rolling-haven" element={
                <>
                  <Header />
                  <RollingHavenPage />
                  <Footer />
              ...
              <Route path="/collections/torque-tuner" element={
                <>
                  <Header />
              ...
              <Route path="/collections/custom-workshops" element={
                <>
                  <Header />
                  <CustomWorkshopsPage />
                  <Footer />
              ...
              <Route path="/collections/dc-designs" element={
                <>
                  <Header />
                  <DCDesignsPage />
                  <Footer />
              ...
              <Route path="/collections/heritage-restoration" element={
                <>
                  <Header />
              ...
              <Route path="/collections/luxury-nomad" element={
                <>
                  <Header />
                  <LuxuryNomadPage />
                  <Footer />
              ...
              <Route path="/collections/motormind-designs" element={
                <>
                  <Header />
              ...
              <Route path="/collections/precision-craft" element={
                <>
                  <Header />
              ...
              <Route path="/collections/velocity-customs" element={
                <>
                  <Header />
                  <VelocityCustomsPage />
                  <Footer />
              ...
              <Route path="/collections/wanderlust-caravans" element={
                <>
                  <Header />
              ...
              <Route path="/rentals/:id/book" element={
                <>
                  <Header />
                  <RentalBookingPage />
                  <Footer />
              ...
              <Route path="/rentals/manage" element={
                <ProtectedRoute>
                  <>
                    <Header />
