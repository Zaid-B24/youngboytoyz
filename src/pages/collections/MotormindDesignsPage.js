...
const DesignerImage = styled.div`
  height: 400px;
  background: url('https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80') center center/cover no-repeat;
  border-radius: 10px;
  position: relative;
...
const MotormindDesignsPage = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Motormind BMW M4 Track Edition",
      price: "₹95,00,000",
      ...
      specs: ["3.0L Twin-Turbo", "550 HP", "RWD"],
      badge: "Track Edition"
    },
    {
      id: 2,
      title: "Motormind Audi RS5 Performance",
      price: "₹88,00,000",
      ...
      specs: ["2.9L V6 Turbo", "480 HP", "AWD"],
      badge: "Performance"
    },
    {
      id: 3,
      title: "Motormind Mercedes AMG C63",
      price: "₹92,00,000",
      ...
      specs: ["4.0L V8 Turbo", "510 HP", "RWD"],
      badge: "AMG Tuned"
    },
    {
      id: 4,
      title: "Motormind Nissan GT-R",
      price: "₹1,15,00,000",
      ...
      specs: ["3.8L V6 Turbo", "650 HP", "AWD"],
      badge: "GT-R Spec"
    },
    {
      id: 5,
      title: "Motormind Ford Mustang GT",
      price: "₹65,00,000",
      ...
      specs: ["5.0L V8", "480 HP", "RWD"],
      badge: "American Muscle"
    },
    {
      id: 6,
      title: "Motormind Subaru WRX STI",
      price: "₹45,00,000",
      ...
      specs: ["2.5L Turbo H4", "350 HP", "AWD"],
      badge: "Rally Inspired"
    }
  ];
    ...
    <PageWrapper>
      <HeroSection>
        <HeroContainer>
          <DesignerImage />
          <DesignerInfo>
            <DesignerName>Motormind Designs</DesignerName>
            <DesignerTitle>Performance & Aesthetics</DesignerTitle>
            <DesignerDescription>
              Founded in 2013, Motormind Designs has carved a niche in the high-performance automotive modification 
              sector. We specialize in combining cutting-edge technology with artistic vision to create vehicles 
              that deliver exceptional performance without compromising on aesthetics. Our team of engineers and 
              designers work closely to develop modifications that enhance both power and visual appeal.
            </DesignerDescription>
            <DesignerMeta>
              <MetaItem>
                <Calendar size={16} />
      ...
      <ProductsSection>
        <SectionTitle>Performance Creations</SectionTitle>
        <ProductsGrid>
...
export default MotormindDesignsPage; 